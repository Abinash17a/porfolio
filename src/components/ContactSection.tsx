...
<section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden bg-white font-pixel">
  <div className="container mx-auto max-w-7xl relative z-10">
    ...
    <div className="grid grid-cols-1 md:grid-cols-5 gap-8 sm:gap-10 lg:gap-16 items-start">
      ...
      >
        <div className="bg-white border-4 border-blue-500 p-6 sm:p-8" style={{ boxShadow: '4px 4px 0px #fff, 8px 8px 0px #fff' }}>
          <h3 className="text-xl sm:text-2xl font-bold text-blue-600 mb-8" style={{ textShadow: '2px 2px 0px #fff' }}>
            CONTACT INFO
          </h3>
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <div>
                ...
                <a href="mailto:abinashchhetri.44@gmail.com" className="text-lg font-medium text-gray-900 hover:text-blue-600 transition-colors" style={{ textShadow: '1px 1px 0px #fff' }}>
            ...
            >
              ...
              <div>
                ...
                <a href="tel:+916296344129" className="text-lg font-medium text-gray-900 hover:text-green-600 transition-colors" style={{ textShadow: '1px 1px 0px #fff' }}>
                  +91 6296-344-129
                </a>
              </div>
            </motion.div>
          ...
          <motion.div
            ...
            className="mt-10"
          >
            <div className="relative h-64 sm:h-72 md:h-80 border-4 border-blue-500 overflow-hidden" style={{ boxShadow: '2px 2px 0px #fff' }}>
              <iframe
              ...
              ></iframe>
              {/* Decorative blocks */}
              <div className="absolute top-5 left-5 w-8 h-8 bg-blue-200 hidden sm:block" />
              <div className="absolute bottom-5 right-5 w-6 h-6 bg-green-200 hidden sm:block" />
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-12 h-12 bg-yellow-200 hidden sm:block" />
            </div>
          </motion.div>
        </div>
      </motion.div>
